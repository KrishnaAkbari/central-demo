...
// FieldRow — convenience wrapper preserved from the base-ui version.
// Composes Field + FieldLabel + FieldContent + FieldDescription + FieldError
// around a single control (Input / Select / Textarea). 18 callsites use it.
function FieldRow({
  label,
  htmlFor,
  helper,
